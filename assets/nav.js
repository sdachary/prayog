(function(){
  ...
  nav.innerHTML = '<a href="/" style="font-family:var(--mono);font-size:11px;color:var(--muted);text-decoration:none;letter-spacing:0.06em">PRAYOG<span style="color:var(--amber)">//</span>TOOLS</a>' +
    ...
    '<span style="flex:1"></span><a href="/privacy" style="font-family:var(--mono);font-size:11px;color:var(--muted);text-decoration:none;letter-spacing:0.06em">PRIVACY</a>' +
    '<span style="font-family:var(--mono);font-size:11px;color:var(--muted);margin:0 6px">·</span>' +
    '<a href="/terms" style="font-family:var(--mono);font-size:11px;color:var(--muted);text-decoration:none;letter-spacing:0.06em">TERMS</a>';
